    ...
    const fetchMedicalHistory = async () => {
      try {
        ...
        if (historyData.medicalHistory) {
          setMedicalHistory(Array.isArray(historyData.medicalHistory) ? historyData.medicalHistory : []);
                      ...
                      <div className="card-body">
                        ...
                        {record.treatmentDescription && (
                          <div className="mb-3">
                            ...
                            <p className="mb-0">{record.treatmentDescription}</p>
                          </div>
                        )}
                        {record.medications && (
                          <div className="mb-3">
                        ...
                        {record.allergies && (
                          <div className="mb-3">
                            ...
                            <p className="mb-0 text-warning">{record.allergies}</p>
                          </div>
                        )}
