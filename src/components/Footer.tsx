        ...
        <div className="container py-5">
          <div className="row g-5">
            <div className="col-lg-3 col-md-6">
              ...
              <p className="mb-2">
                <i className="fa fa-map-marker-alt text-primary me-3"></i>123 Street, New York, USA
              </p>
              <p className="mb-2">
                <i className="fa fa-envelope text-primary me-3"></i>info@example.com
              </p>
              <p className="mb-0">
                <i className="fa fa-phone-alt text-primary me-3"></i>+012 345 67890
              </p>
            </div>
            <div className="col-lg-3 col-md-6">
              <h4 className="d-inline-block text-primary text-uppercase border-bottom border-5 border-secondary mb-4">
              ...
              <div className="d-flex flex-column justify-content-start">
                <Link className="text-light mb-2" href="/">
                  <i className="fa fa-angle-right me-2"></i>Home
                </Link>
                <Link className="text-light mb-2" href="/about">
                  <i className="fa fa-angle-right me-2"></i>About Us
                </Link>
                <Link className="text-light mb-2" href="/service">
                  <i className="fa fa-angle-right me-2"></i>Our Services
                </Link>
                <Link className="text-light mb-2" href="/team">
                  <i className="fa fa-angle-right me-2"></i>Meet The Team
                </Link>
                <Link className="text-light mb-2" href="/blog">
